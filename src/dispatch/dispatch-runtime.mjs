...
export function renderDispatchPrompt({
  ...
  return [
    ...
    '14) Prototype-style asks may generate local artifacts and may publish them only through a safe private provider using a private-or-skip policy. Exclude any temporary trailing Ask: helper block from the final saved note and treat it only as optional rewrite guidance.',
